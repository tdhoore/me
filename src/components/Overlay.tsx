...
export default function Overlay({ camController }) {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 size-full z-10 bg-top bg-radial-[ellipse_at_top_center] from-back-light to-transparent opacity-30 pointer-events-none"></div>
