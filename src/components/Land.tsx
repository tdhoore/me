    ...
    <>
      <ModelProvider>
        <group {...props}>
          ...
          <Bush
            ...
            rotation={[
              3.141592653589793, 1.1693705988362006, -3.141592653589793,
            ]}
          ...
          <Bush
            ...
            rotation={[
              4.787992974268908e-17, 0.03490658503988616, 8.064362226550944e-18,
            ]}
            scale={[1.56, 1.56, 1.56]}
          />
          <Bush
            ...
            rotation={[
              3.141592653589793, 1.0122909661567117, -3.141592653589793,
            ]}
          ...
          <Bush
            ...
            rotation={[
              1.2773603941892003e-16, -1.1868238913561444,
              1.2817014107225127e-16,
            ]}
          ...
          <Bush
            ...
            rotation={[
              4.803354472255525e-17, 0.08726646259971639, 5.548948409624735e-18,
            ]}
          ...
          <Bush
            ...
            rotation={[
              5.771844867740946e-17, -0.5934119456780722, 4.201109457646978e-17,
            ]}
          ...
          />
          <Ruin
            position={[-26.38, -1.09, -27.27]}
            rotation={[
              -0.19498820207907583, -0.7439910587470819, -0.4049144275513527,
            ]}
          />
          <Ruin
            position={[-30.72, -1.09, -20.75]}
            rotation={[
              0.6622826725849318, 0.553969585637884, -0.47624154168613797,
            ]}
          />
          <Ruin
            position={[-23.86, -1.09, -23.47]}
            rotation={[
              2.7038957312211864, -0.42758839394819154, 2.771260854976603,
            ]}
          />
          <Ruin
            position={[-24, -1.41, -26.07]}
            rotation={[
              2.225264167274902, -0.09260443933731737, -2.927006528931437,
            ]}
          />
          <Ruin
            position={[-30.6, -1.42, -24.52]}
            rotation={[
              2.2414354982672613, -0.3660457644719119, 2.5544342230107424,
            ]}
          />
          <Tower
            ...
            receiveShadow={true}
            visible={false}
            rotation={[-0.15707963267948966, -0.22689280275926285, 0]}
          />
          <Well position={[-15.68, 0, -9.87]} />
          <Tree position={[-17.64, 0.04, -16.86]} />
          <Tree
            position={[-25.22, 0.04, -28.96]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, -1.553343034274955, 0]}
          />
          <Tree
            position={[-21.68, 0.04, -27.78]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, 1.535889741755011, 0]}
          />
          <Tree
            position={[-20.16, 0.04, -20.17]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, 1.535889741755011, 0]}
          />
          <Tree
            position={[-20.48, 0.04, -16.96]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, 0.4886921905584136, 0]}
          />
          <Tree
            position={[-30.62, 0.04, -17.85]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, 0.24434609527920736, 0]}
          />
          <Tree
            position={[-21.36, 0.04, -2.7]}
            scale={[1.19, 1.19, 1.19]}
            rotation={[0, -1.4311699866353498, 0]}
          />
          <Tree
            position={[-32.4, 0.04, -23.4]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[
              3.141592653589793, -0.5934119456780722, 3.141592653589793,
            ]}
          />
          <Tree
            position={[-29.58, 0.04, -20.78]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, -1.5707963267948966, 0]}
          />
          <Tree
            position={[-33.1, 0.04, -20.52]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, -1.3264502315156905, 0]}
          />
          <Tree
          ...
          />
          <Tree
            position={[-29.58, 0.04, -31.3]}
            scale={[1.08, 1.08, 1.08]}
            rotation={[0, -1.221730476396032, 0]}
          />
          <Tree
          ...
          <Tree
            position={[-6.98, 0.04, -11.55]}
            scale={[1.05, 1.05, 1.05]}
            rotation={[
              -3.141592653589793, 0.24434609527920592, -3.141592653589793,
            ]}
          />
      ...
      <group>
        ...
        <Box
          ...
          rotation={[
            -0.27206561078047115, -0.03558191099515721, -0.25311477863584225,
          ]}
          scale={[1.95, 2.75, 0.22]}
          quaternion={[0, 0, 0, 0]}
        >
          <meshPhysicalMaterial />
        </Box>
        <Box
          ...
          rotation={[
            -0.10692885877974853, 0.16833561786252965, 0.30500120784906926,
          ]}
          scale={[1.53, 1.78, 0.22]}
          quaternion={[0, 0, 0, 0]}
        >
          <meshPhysicalMaterial />
        </Box>
